...
describe('DurationGenerator', () => {
    ...
    describe('in english', () => {
        it('generate duration without end', () => {
            ...
            assert.equal(duration, `<time-duration><time datetime="Mon Aug 14 2023">2023</time> – Present</time-duration>`);
        });
        ...
        it('generate duration with start and end', () => {
            ...
            assert.equal(duration, `<time-duration><time datetime="Mon Aug 14 2023">2023</time> – <time datetime="Thu Aug 14 2025">2025</time></time-duration>`);
        });
    });
